...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/shastrax/funny-iguana/gen/proto/iguana/v1"
	http "net/http"
	strings "strings"
)
...
var (
	iguanaServiceServiceDescriptor            = v1.File_proto_iguana_v1_iguana_proto.Services().ByName("IguanaService")
