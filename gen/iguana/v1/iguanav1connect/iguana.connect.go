...
const (
	...
	// IguanaServiceUserGroupDetailProcedure is the fully-qualified name of the IguanaService's
	// UserGroupDetail RPC.
	IguanaServiceUserGroupDetailProcedure = "/iguana.v1.IguanaService/UserGroupDetail"
...
var (
	...
	iguanaServiceUserGroupDetailMethodDescriptor = iguanaServiceServiceDescriptor.Methods().ByName("UserGroupDetail")
...
type IguanaServiceClient interface {
	...
	UserGroupDetail(context.Context, *connect.Request[v1.UserGroupDetailRequest]) (*connect.Response[v1.UserGroupDetailResponse], error)
...
func NewIguanaServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) IguanaServiceClient {
	...
	return &iguanaServiceClient{
		...
		userGroupDetail: connect.NewClient[v1.UserGroupDetailRequest, v1.UserGroupDetailResponse](
			httpClient,
			baseURL+IguanaServiceUserGroupDetailProcedure,
			connect.WithSchema(iguanaServiceUserGroupDetailMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
...
type iguanaServiceClient struct {
	...
	userGroupDetail *connect.Client[v1.UserGroupDetailRequest, v1.UserGroupDetailResponse]
...
// UserGroupDetail calls iguana.v1.IguanaService.UserGroupDetail.
func (c *iguanaServiceClient) UserGroupDetail(ctx context.Context, req *connect.Request[v1.UserGroupDetailRequest]) (*connect.Response[v1.UserGroupDetailResponse], error) {
	return c.userGroupDetail.CallUnary(ctx, req)
}
...
func NewIguanaServiceHandler(svc IguanaServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	iguanaServiceUserGroupDetailHandler := connect.NewUnaryHandler(
		IguanaServiceUserGroupDetailProcedure,
		svc.UserGroupDetail,
		connect.WithSchema(iguanaServiceUserGroupDetailMethodDescriptor),
		connect.WithHandlerOptions(opts...),
	)
	...
	return "/iguana.v1.IguanaService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case IguanaServiceUserGroupDetailProcedure:
			iguanaServiceUserGroupDetailHandler.ServeHTTP(w, r)
...
func (UnimplementedIguanaServiceHandler) UserGroupDetail(context.Context, *connect.Request[v1.UserGroupDetailRequest]) (*connect.Response[v1.UserGroupDetailResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("iguana.v1.IguanaService.UserGroupDetail is not implemented"))
}
