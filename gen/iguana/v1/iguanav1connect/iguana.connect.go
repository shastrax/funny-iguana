...
const (
	...
	// IguanaServiceUserRoleProcedure is the fully-qualified name of the IguanaService's UserRole RPC.
	IguanaServiceUserRoleProcedure = "/iguana.v1.IguanaService/UserRole"
	// IguanaServiceUserSuspendProcedure is the fully-qualified name of the IguanaService's UserSuspend
	// RPC.
	IguanaServiceUserSuspendProcedure = "/iguana.v1.IguanaService/UserSuspend"
	// IguanaServiceUserUpdateProcedure is the fully-qualified name of the IguanaService's UserUpdate
	// RPC.
	IguanaServiceUserUpdateProcedure = "/iguana.v1.IguanaService/UserUpdate"
...
var (
	...
	iguanaServiceUserRoleMethodDescriptor     = iguanaServiceServiceDescriptor.Methods().ByName("UserRole")
	iguanaServiceUserSuspendMethodDescriptor  = iguanaServiceServiceDescriptor.Methods().ByName("UserSuspend")
	iguanaServiceUserUpdateMethodDescriptor   = iguanaServiceServiceDescriptor.Methods().ByName("UserUpdate")
...
type IguanaServiceClient interface {
	...
	UserRole(context.Context, *connect.Request[v1.UserRoleRequest]) (*connect.Response[v1.UserRoleResponse], error)
	UserSuspend(context.Context, *connect.Request[v1.UserSuspendRequest]) (*connect.Response[v1.UserSuspendResponse], error)
	UserUpdate(context.Context, *connect.Request[v1.UserUpdateRequest]) (*connect.Response[v1.UserUpdateResponse], error)
...
func NewIguanaServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) IguanaServiceClient {
	...
	return &iguanaServiceClient{
		...
		userRole: connect.NewClient[v1.UserRoleRequest, v1.UserRoleResponse](
			httpClient,
			baseURL+IguanaServiceUserRoleProcedure,
			connect.WithSchema(iguanaServiceUserRoleMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
		userSuspend: connect.NewClient[v1.UserSuspendRequest, v1.UserSuspendResponse](
			httpClient,
			baseURL+IguanaServiceUserSuspendProcedure,
			connect.WithSchema(iguanaServiceUserSuspendMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
		userUpdate: connect.NewClient[v1.UserUpdateRequest, v1.UserUpdateResponse](
			httpClient,
			baseURL+IguanaServiceUserUpdateProcedure,
			connect.WithSchema(iguanaServiceUserUpdateMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
		userGroup: connect.NewClient[v1.UserGroupRequest, v1.UserGroupResponse](
			httpClient,
			baseURL+IguanaServiceUserGroupProcedure,
			connect.WithSchema(iguanaServiceUserGroupMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
...
type iguanaServiceClient struct {
	...
	userRole     *connect.Client[v1.UserRoleRequest, v1.UserRoleResponse]
	userSuspend  *connect.Client[v1.UserSuspendRequest, v1.UserSuspendResponse]
	userUpdate   *connect.Client[v1.UserUpdateRequest, v1.UserUpdateResponse]
...
// UserRole calls iguana.v1.IguanaService.UserRole.
func (c *iguanaServiceClient) UserRole(ctx context.Context, req *connect.Request[v1.UserRoleRequest]) (*connect.Response[v1.UserRoleResponse], error) {
	return c.userRole.CallUnary(ctx, req)
}

// UserSuspend calls iguana.v1.IguanaService.UserSuspend.
func (c *iguanaServiceClient) UserSuspend(ctx context.Context, req *connect.Request[v1.UserSuspendRequest]) (*connect.Response[v1.UserSuspendResponse], error) {
	return c.userSuspend.CallUnary(ctx, req)
}

// UserUpdate calls iguana.v1.IguanaService.UserUpdate.
func (c *iguanaServiceClient) UserUpdate(ctx context.Context, req *connect.Request[v1.UserUpdateRequest]) (*connect.Response[v1.UserUpdateResponse], error) {
...
func NewIguanaServiceHandler(svc IguanaServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	iguanaServiceUserRoleHandler := connect.NewUnaryHandler(
		IguanaServiceUserRoleProcedure,
		svc.UserRole,
		connect.WithSchema(iguanaServiceUserRoleMethodDescriptor),
		connect.WithHandlerOptions(opts...),
	)
	iguanaServiceUserSuspendHandler := connect.NewUnaryHandler(
		IguanaServiceUserSuspendProcedure,
		svc.UserSuspend,
		connect.WithSchema(iguanaServiceUserSuspendMethodDescriptor),
		connect.WithHandlerOptions(opts...),
	)
	iguanaServiceUserUpdateHandler := connect.NewUnaryHandler(
		IguanaServiceUserUpdateProcedure,
		svc.UserUpdate,
		connect.WithSchema(iguanaServiceUserUpdateMethodDescriptor),
		connect.WithHandlerOptions(opts...),
	)
	...
	return "/iguana.v1.IguanaService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case IguanaServiceUserRoleProcedure:
			iguanaServiceUserRoleHandler.ServeHTTP(w, r)
		case IguanaServiceUserSuspendProcedure:
			iguanaServiceUserSuspendHandler.ServeHTTP(w, r)
		case IguanaServiceUserUpdateProcedure:
			iguanaServiceUserUpdateHandler.ServeHTTP(w, r)
...
func (UnimplementedIguanaServiceHandler) UserRole(context.Context, *connect.Request[v1.UserRoleRequest]) (*connect.Response[v1.UserRoleResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("iguana.v1.IguanaService.UserRole is not implemented"))
}

func (UnimplementedIguanaServiceHandler) UserSuspend(context.Context, *connect.Request[v1.UserSuspendRequest]) (*connect.Response[v1.UserSuspendResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("iguana.v1.IguanaService.UserSuspend is not implemented"))
}

func (UnimplementedIguanaServiceHandler) UserUpdate(context.Context, *connect.Request[v1.UserUpdateRequest]) (*connect.Response[v1.UserUpdateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("iguana.v1.IguanaService.UserUpdate is not implemented"))
}
...
func (UnimplementedIguanaServiceHandler) UserGroup(context.Context, *connect.Request[v1.UserGroupRequest]) (*connect.Response[v1.UserGroupResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("iguana.v1.IguanaService.UserGroup is not implemented"))
}
