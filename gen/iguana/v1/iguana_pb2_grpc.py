...
class IguanaServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UserRole = channel.unary_unary(
                '/iguana.v1.IguanaService/UserRole',
                request_serializer=iguana_dot_v1_dot_iguana__pb2.UserRoleRequest.SerializeToString,
                response_deserializer=iguana_dot_v1_dot_iguana__pb2.UserRoleResponse.FromString,
                )
        self.UserSuspend = channel.unary_unary(
                '/iguana.v1.IguanaService/UserSuspend',
                request_serializer=iguana_dot_v1_dot_iguana__pb2.UserSuspendRequest.SerializeToString,
                response_deserializer=iguana_dot_v1_dot_iguana__pb2.UserSuspendResponse.FromString,
                )
        self.UserUpdate = channel.unary_unary(
                '/iguana.v1.IguanaService/UserUpdate',
                request_serializer=iguana_dot_v1_dot_iguana__pb2.UserUpdateRequest.SerializeToString,
                response_deserializer=iguana_dot_v1_dot_iguana__pb2.UserUpdateResponse.FromString,
                )
...
class IguanaServiceServicer(object):
    ...
    def UserSuspend(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_IguanaServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'UserRole': grpc.unary_unary_rpc_method_handler(
                    servicer.UserRole,
                    request_deserializer=iguana_dot_v1_dot_iguana__pb2.UserRoleRequest.FromString,
                    response_serializer=iguana_dot_v1_dot_iguana__pb2.UserRoleResponse.SerializeToString,
            ),
            'UserSuspend': grpc.unary_unary_rpc_method_handler(
                    servicer.UserSuspend,
                    request_deserializer=iguana_dot_v1_dot_iguana__pb2.UserSuspendRequest.FromString,
                    response_serializer=iguana_dot_v1_dot_iguana__pb2.UserSuspendResponse.SerializeToString,
            ),
            'UserUpdate': grpc.unary_unary_rpc_method_handler(
                    servicer.UserUpdate,
                    request_deserializer=iguana_dot_v1_dot_iguana__pb2.UserUpdateRequest.FromString,
                    response_serializer=iguana_dot_v1_dot_iguana__pb2.UserUpdateResponse.SerializeToString,
            ),
...
class IguanaService(object):
    ...
    def UserRole(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/iguana.v1.IguanaService/UserRole',
            iguana_dot_v1_dot_iguana__pb2.UserRoleRequest.SerializeToString,
            iguana_dot_v1_dot_iguana__pb2.UserRoleResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def UserSuspend(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/iguana.v1.IguanaService/UserSuspend',
            iguana_dot_v1_dot_iguana__pb2.UserSuspendRequest.SerializeToString,
            iguana_dot_v1_dot_iguana__pb2.UserSuspendResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def UserUpdate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/iguana.v1.IguanaService/UserUpdate',
            iguana_dot_v1_dot_iguana__pb2.UserUpdateRequest.SerializeToString,
            iguana_dot_v1_dot_iguana__pb2.UserUpdateResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
